...
function initControl () {
    ...
    if (havePointerLock) {
        ...
        const pointerlockchange = function () { control.enabled = (document.pointerLockElement === element) }
        const mozpointerlockchange = function () { control.enabled = (document.mozPointerLockElement === element) }
        const webkitpointerlockchange = function () { control.enabled = (document.webkitPointerLockElement === element) }
